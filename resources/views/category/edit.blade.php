...
@section('subtitle', 'Update details for the category ' . $category->name . '.')
...
@section('content')
    <div class="container mx-auto bg-white p-8 rounded-lg shadow-md">
        ...
        <h1 class="text-3xl font-bold text-gray-800 mb-6 text-center">Edit Category: {{ $category->name }}</h1>
