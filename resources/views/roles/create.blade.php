...
<div class="container mx-auto bg-white p-8 rounded-lg shadow-md mt-10">
    ...
    <h1 class="text-3xl font-bold text-gray-800 mb-6 text-center">Create New Role</h1>
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-2">
                @foreach ($permissions as $permission)
                    <label class="inline-flex items-center">
                        <input type="checkbox" name="permissions[]" value="{{ $permission->name }}" class="form-checkbox h-5 w-5 text-blue-600" {{ in_array($permission->name, old('permissions', [])) ? 'checked' : '' }}>
