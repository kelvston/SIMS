...
@section('subtitle', 'Update an existing business expense.')
...
@section('content')
    <div class="container mx-auto bg-white p-8 rounded-lg shadow-md">
        ...
        <h1 class="text-3xl font-bold text-gray-800 mb-6 text-center">Edit Expense</h1>
        ...
        <form action="{{ route('expenses.update', $expense->id) }}" method="POST">
            ...
            <div class="flex items-center justify-between">
                <button type="submit"
                        class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-6 rounded-full focus:outline-none focus:shadow-outline transition duration-300 ease-in-out shadow-lg">
                    Update Expense
                </button>
