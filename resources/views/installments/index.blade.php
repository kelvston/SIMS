        ...
        <div class="overflow-x-auto rounded-lg border border-gray-200 shadow-sm">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Phones</th>
                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Final Amount</th>
                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Installment Amount</th>
                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Total Installments</th>
                ...
                @foreach ($installmentPlans as $plan)
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $plan->sale->customer_name }}</td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">${{ number_format($plan->sale->final_amount, 2) }}</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">${{ number_format($plan->installment_amount, 2) }}</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $plan->total_installments }}</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $plan->next_payment_date ? $plan->next_payment_date->format('Y-m-d') : 'N/A' }}</td>
