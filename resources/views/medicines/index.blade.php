    ...
    <div class="container mx-auto bg-white p-8 rounded-lg shadow-md mt-10 relative">
        ...
        @can('receive medicines')
            <div class="flex justify-end mb-8 space-x-2">
                ...
                <a href="{{ route('reports.stock') }}" class="bg-gray-500 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded-full transition duration-300 ease-in-out shadow-md">
