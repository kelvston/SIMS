    ...
    <div class="container mx-auto bg-white p-8 rounded-lg shadow-md">
        ...
        <form action="{{ route('products.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" id="name" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('name') border-red-500 @enderror" value="{{ old('name') }}" placeholder="e.g., Cashew, wine, roasted cashew" required>
                @error('name')
