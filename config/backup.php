    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                ...
                'follow_links' => false,
                'ignore_unreadable_directories' => false,
                 'relative_path' => base_path(), // this is required
            ],
            'databases' => [
                'mysql',  // or whatever DB connection you are using
            ],
        ],
        'destination' => [
            'disks' => [
                'local',  // e.g. use local disk or another disk configured in filesystems
            ],
        ],
        // other settings...
    ],
...
//    ],
    'cleanup' => [
        ...
        'defaultStrategy' => [
            ...
            'deleteOldestBackupsWhenUsingMoreMegabytesThan' => 0,  // or a limit if you want
        ],
    ],
